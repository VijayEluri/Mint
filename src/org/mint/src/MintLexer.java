// $ANTLR 2.7.2a2 (20020112-1): "MintParser.g" -> "MintLexer.java"$
...
public class MintLexer extends antlr.CharScanner implements MintParserTokenTypes, TokenStream
 {
public MintLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public MintLexer(Reader in) {
	this(new CharBuffer(in));
}
public MintLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public MintLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("for", this), new Integer(34));
	literals.put(new ANTLRHashString("false", this), new Integer(65));
	literals.put(new ANTLRHashString("true", this), new Integer(64));
	literals.put(new ANTLRHashString("continue", this), new Integer(39));
	...
	literals.put(new ANTLRHashString("break", this), new Integer(37));
	literals.put(new ANTLRHashString("return", this), new Integer(40));
	literals.put(new ANTLRHashString("if", this), new Integer(30));
